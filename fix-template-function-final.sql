-- Final working version of the template copying function
...
BEGIN
    ...
    IF template_subject_id IS NULL THEN
        ...
        VALUES (
            ...
            generate_readable_class_code('CELL'),
            true,
            NOW(),
            NOW()
    ...
    -- Generate a unique class code (UPPERCASE ONLY)
    new_class_code := generate_readable_class_code('CELL');
